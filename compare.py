...
working_folder = '14_test'  #where the nc data is located
...
# Site description, extra fields description in excel file
...
nc1 = Dataset(files[0], mode='r')
nc2 = Dataset(files[1], mode='r')
#%%
nc1.groups[level_1].variables[level_2]



#%%
nc2.groups[level_1].variables[level_2]
